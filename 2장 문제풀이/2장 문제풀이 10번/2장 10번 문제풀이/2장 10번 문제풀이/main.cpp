...
void Excersize_2_10(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("이후에 Δv,a 이를 활용하여 Δt 를 구해주면 됩니다.\n");
	...
	if (answer == SHOW)
	{
		...
		printf("관련 공식 Δt=Δv/a 에 대입하면\n");
		printf("Δt = ( %6.2lf m/s - %6.2lf m/s) / %6.2lf m/s^2 , Δt = %6.2lf s \n", final_velocity, frist_velocity, acceleration, time);
